...
insert into User (id, fbID, nome, email,pontuacao ) values (0,'35323' , 'John Smith', 'john.smith@mailinator.com',0)
insert into User (id, fbID, nome, email,pontuacao ) values (1,'45453' , 'vitor', 'vitor@vitor.com',0)
