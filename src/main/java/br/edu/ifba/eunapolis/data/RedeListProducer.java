...
public class RedeListProducer {
    ...
    public void onRedeListChanged(@Observes(notifyObserver = Reception.IF_EXISTS) final Rede rede) {
        retrieveAllRedesOrderedByName();
    }

    @PostConstruct
    public void retrieveAllRedesOrderedByName() {
        redes = redeRepository.findAllOrderedByName();
    }
}
